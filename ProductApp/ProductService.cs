...
namespace ProductApp
{
    public class ProductService
    {
        ...
        public IEnumerable<Product> GetProducts()
        {
            ...
            _lst.Add(new Product() { ProductID = 1, ProductName = "CPU", Quantity = 100 });
            _lst.Add(new Product() { ProductID = 2, ProductName = "Graphic Card", Quantity = 200 });
            _lst.Add(new Product() { ProductID = 3, ProductName = "Monitor", Quantity = 10000 });
